import 'package:cicle_mobile_f3/controllers/my_task_schedule_all_controller.dart';
...
class MyTaskSchedule extends StatelessWidget {
  MyTaskSchedule({Key? key}) : super(key: key);

  RefreshController refreshController =
      RefreshController(initialRefresh: false);

  Future<bool> onRefresh(MyTaskScheduleAllController scheduleController) async {
    try {
  ...
  Widget build(BuildContext context) {
    return GetX<MyTaskScheduleAllController>(
        init: MyTaskScheduleAllController(),
        initState: (state) {
  ...
  SmartRefresher _buildHasData(List<EventItemModel> value,
      MyTaskScheduleAllController scheduleController) {
  ...
  Container _buildCalendar(MyTaskScheduleAllController scheduleController) {
  ...
  Widget _buildCollapseHeader(MyTaskScheduleAllController scheduleController) {
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
        color: Colors.white,
